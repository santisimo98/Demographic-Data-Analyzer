...
# Read data from file
    ...
    rich_percentage = round(((df['salary'] == '>50K') & num_min_workers).mean() * 100,1)

    # What country has the highest percentage of people that earn >50K?
    highest_earning_country = (df[df['salary'] =='>50K']['native-country'].value_counts()).idxmax()
    highest_earning_country_percentage = round((df[df['salary'] =='>50K']['native-country'].value_counts()).max()/(df['salary'] == '>50K').count()*100,1)
